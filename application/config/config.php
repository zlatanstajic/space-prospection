...
| The APP_BASE_URL environment variable overrides the local default below.
|
...
$config['base_url'] = $app_base_url === FALSE ? 'http://localhost:8080' : $app_base_url;
...
*/
$config['composer_autoload'] = getenv('SKIP_COMPOSER_AUTOLOAD') === '1' ? FALSE : TRUE;
